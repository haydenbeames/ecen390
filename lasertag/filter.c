...
// Filter Coefficients
const static double fir_coef[FIR_COEF_COUNT] = {0.0,
                                                3.8342823682706231e-06,
                                                1.8434064577496714e-05,
                                                4.3060491068262203e-05,
                                                6.8631079589207919e-05,
                                                7.8200362324506827e-05,
                                                5.0102879271319798e-05,
                                                -3.6266988484992889e-05,
                                                -1.9270375257708750e-04,
                                                -4.1387385496878429e-04,
                                                -6.7051426702074805e-04,
                                                -9.0661140624107158e-04,
                                                -1.0428833238331600e-03,
                                                -9.8805880576526180e-04,
                                                -6.5791632788934223e-04,
                                                8.0500245874684433e-19,
                                                9.8024085406310632e-04,
                                                2.1978984227582011e-03,
                                                3.4784175278154703e-03,
                                                4.5648660041106197e-03,
                                                5.1464217547564665e-03,
                                                4.9080082807048840e-03,
                                                3.5962648215440043e-03,
                                                1.0922779580756008e-03,
                                                -2.5221861909812873e-03,
                                                -6.9197914522424403e-03,
                                                -1.1517667555764310e-02,
                                                -1.5511646188481250e-02,
                                                -1.7957031761487947e-02,
                                                -1.7889731262750234e-02,
                                                -1.4473018146767496e-02,
                                                -7.1483446400393445e-03,
                                                4.2349826871505942e-03,
                                                1.9335722047565503e-02,
                                                3.7301326020617906e-02,
                                                5.6823053849101399e-02,
                                                7.6263450588519716e-02,
                                                9.3841702665884402e-02,
                                                1.0785179614821015e-01,
                                                1.1688166247967095e-01,
                                                1.1999999999999998e-01,
                                                1.1688166247967095e-01,
                                                1.0785179614821015e-01,
                                                9.3841702665884402e-02,
                                                7.6263450588519716e-02,
...
const static double iir_a_coef[NUM_IIR_FILTERS][IIR_A_COEF_COUNT] = {
    {-5.9637727070164015e+00, 1.9125339333078248e+01, -4.0341474540744173e+01,
     ...
     9.0332828533799547e-01}, // channel 1
    {-4.6377947119071505e+00, 1.3502215749461598e+01, -2.6155952405269829e+01,
     3.8589668330738476e+01, -4.3038990303252795e+01, 3.7812927599537275e+01,
     -2.5113598088113893e+01, 1.2703182701888142e+01, -4.2755083391143689e+00,
     9.0332828533800569e-01}, // channel 2
    {-3.0591317915750973e+00, 8.6417489609637634e+00, -1.4278790253808870e+01,
     2.1302268283304350e+01, -2.2193853972079282e+01, 2.0873499791105495e+01,
     -1.3709764520609433e+01, 8.1303553577931904e+00, -2.8201643879900606e+00,
     9.0332828533800258e-01}, // channel 3
    {-1.4071749185996769e+00, 5.6904141470697596e+00, -5.7374718273676431e+00,
     1.1958028362868930e+01, -8.5435280598354897e+00, 1.1717345583836000e+01,
     -5.5088290876998869e+00, 5.3536787286077878e+00, -1.2972519209655655e+00,
     9.0332828533800436e-01}, // channel 4
    {8.2010906117760696e-01, 5.1673756579268639e+00, 3.2580350909221076e+00,
     ...
     9.0332828533800136e-01}, // channel 5
    {2.7080869856154512e+00, 7.8319071217995688e+00, 1.2201607990980744e+01,
     ...
     9.0332828533800436e-01}, // channel 6
    {4.9479835250075892e+00, 1.4691607003177602e+01, 2.9082414772101060e+01,
     ...
     9.0332828533799958e-01}, // channel 7
    {6.1701893352279846e+00, 2.0127225876810336e+01, 4.2974193398071684e+01,
     ...
     9.0332828533799803e-01}, // channel 8
    {7.4092912870072398e+00, 2.6857944460290135e+01, 6.1578787811202247e+01,
     ...
     9.0332828533799969e-01}, // channel 9
    {8.5743055776347692e+00, 3.4306584753117889e+01, 8.4035290411037053e+01,
     ...
     9.0332828533799636e-01}}; // channel 10

const static double iir_b_coef[NUM_IIR_FILTERS][IIR_B_COEF_COUNT] = {
    {9.0928661148194738e-10, 0.0000000000000000e+00, -4.5464330574097372e-09,
     ...
     0.0000000000000000e+00, -9.0928661148194738e-10}, // channel 1
    {9.0928661148175165e-10, 0.0000000000000000e+00, -4.5464330574087587e-09,
     0.0000000000000000e+00, 9.0928661148175174e-09, 0.0000000000000000e+00,
     -9.0928661148175174e-09, 0.0000000000000000e+00, 4.5464330574087587e-09,
     0.0000000000000000e+00, -9.0928661148175165e-10}, // channel 2
    {9.0928661148192040e-10, 0.0000000000000000e+00, -4.5464330574096024e-09,
     0.0000000000000000e+00, 9.0928661148192048e-09, 0.0000000000000000e+00,
     -9.0928661148192048e-09, 0.0000000000000000e+00, 4.5464330574096024e-09,
     0.0000000000000000e+00, -9.0928661148192040e-10}, // channel 3
    {9.0928661148191275e-10, 0.0000000000000000e+00, -4.5464330574095635e-09,
     0.0000000000000000e+00, 9.0928661148191270e-09, 0.0000000000000000e+00,
     -9.0928661148191270e-09, 0.0000000000000000e+00, 4.5464330574095635e-09,
     0.0000000000000000e+00, -9.0928661148191275e-10}, // channel 4
    {9.0928661148211809e-10, 0.0000000000000000e+00, -4.5464330574105901e-09,
     0.0000000000000000e+00, 9.0928661148211801e-09, 0.0000000000000000e+00,
     -9.0928661148211801e-09, 0.0000000000000000e+00, 4.5464330574105901e-09,
     0.0000000000000000e+00, -9.0928661148211809e-10}, // channel 5
    {9.0928661148179839e-10, 0.0000000000000000e+00, -4.5464330574089919e-09,
     ...
     0.0000000000000000e+00, -9.0928661148179839e-10}, // channel 6
    {9.0928661148193684e-10, 0.0000000000000000e+00, -4.5464330574096843e-09,
     ...
     0.0000000000000000e+00, -9.0928661148193684e-10}, // channel 7
    {9.0928661148195069e-10, 0.0000000000000000e+00, -4.5464330574097538e-09,
     ...
     0.0000000000000000e+00, -9.0928661148195069e-10}, // channel 8
    {9.0928661148190954e-10, 0.0000000000000000e+00, -4.5464330574095478e-09,
     ...
     0.0000000000000000e+00, -9.0928661148190954e-10}, // channel 9
    {9.0928661148206091e-10, 0.0000000000000000e+00, -4.5464330574103047e-09,
     ...
     0.0000000000000000e+00, -9.0928661148206091e-10}}; // channel 10

// array for current power values - initialized to zero
static double currentPowerValue[NUM_IIR_FILTERS] = {
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE,
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE,
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE};
// saves oldest value to subtract from power - efficient power calculation
static double oldestValue[NUM_IIR_FILTERS] = {
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE,
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE, INIT_VAL_DOUBLE,
    INIT_VAL_DOUBLE, INIT_VAL_DOUBLE};
...
void initQueue(queue_t *q, uint32_t queueSize, char *name) {
  queue_init(q, queueSize, name);                   // inits queue
...
void initXQueue() {
  initQueue(&xQueue, X_QUEUE_SIZE,
            "x"); // uses custom function to init and fill with values
}

// inits the yQueue using initQueue
void initYQueue() {
  initQueue(&yQueue, Y_QUEUE_SIZE,
            "y"); // uses custom function to init and fill with values
}

// inits all 10 IIR Filter zQueues
void initZQueue() {
  char *name;
  for (uint32_t i = INIT_VAL; i < NUM_IIR_FILTERS;
       i++) {                // makes each queue instance
    sprintf(name, "z%d", i); // creates name for init function
    // zQueue[i] = queue_t q;
    initQueue(&(zQueue[i]), Z_QUEUE_SIZE,
              name); // uses custom function to init and fill with values
  }
}

// inits all 10 Output Filter zQueues
void initOutputQueue() {
  char *name; // creates name for init function
  for (uint32_t i = INIT_VAL; i < NUM_IIR_FILTERS;
       i++) { // makes each queue instance
    sprintf(name, "output%d", i);
    // outputQueue[i] = queue_t q;
    initQueue(&(outputQueue[i]), OUTPUT_QUEUE_SIZE,
              name); // uses custom function to init and fill with values
  }
}
...
void filter_fillQueue(queue_t *q, double fillValue) {
  queue_size_t queueSize = queue_size(q); // saves size
  for (queue_size_t i = INIT_VAL; i < queueSize;
       i++) { // fills with default value
...
double filter_iirFilter(uint16_t filterNumber) {
  ...
  for (uint32_t i = INIT_VAL; i < IIR_B_COEF_COUNT; i++) {
    b_coef_sum += iir_b_coef[filterNumber][i] *
                  queue_readElementAt(&yQueue, IIR_B_COEF_COUNT - 1 - i);
  }
  ...
  for (uint32_t i = INIT_VAL; i < IIR_A_COEF_COUNT; i++) {
    a_coef_sum +=
        iir_a_coef[filterNumber][i] *
        queue_readElementAt(&(zQueue[filterNumber]), IIR_A_COEF_COUNT - 1 - i);
  }
...
double filter_computePower(uint16_t filterNumber, bool forceComputeFromScratch,
  ...
  double oldVal;
  uint32_t qLength =
      queue_elementCount(&(outputQueue[filterNumber])); // access length once
  ...
  if (forceComputeFromScratch) {
    ...
    for (uint32_t i = INIT_VAL; i < qLength; i++) {
      currVal = queue_readElementAt(&(outputQueue[filterNumber]),
                                    i); // access queue once
      power_sum += (currVal * currVal); // summing currVal^2
    }

  } else { // regular calculation
    newVal = queue_readElementAt(&(outputQueue[filterNumber]),
                                 qLength - 1); // pulls newest value
    oldVal =
        oldestValue[filterNumber]; // pulls oldest value (not pushed off queue)
    power_sum = currentPowerValue[filterNumber];
    power_sum +=
        ((newVal * newVal) -
         (oldVal * oldVal)); // adds newest square and subtracts oldest sum
  }

  oldestValue[filterNumber] = queue_readElementAt(
      &(outputQueue[filterNumber]),
      INIT_VAL); // saves oldest index for next power calculation
...
const double *filter_getFirCoefficientArray() { return fir_coef; }
...
uint32_t filter_getYQueueSize() { return queue_elementCount(&yQueue); }

// Returns the decimation value.
uint16_t filter_getDecimationValue() { return FIR_DECIMATION_FACTOR; }
